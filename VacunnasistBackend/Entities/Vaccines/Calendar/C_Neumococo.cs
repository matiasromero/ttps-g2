...
public class C_Neumococo : Vaccine
{
    ...
    protected override Tuple<int?, string> internalValidation(Patient patient)
    {
        ...
        {
            case 0: return (DateTime.Now >= iDate.AddMonths(2)) ? new Tuple<int?, string>(301, "Primera dosis aplicada") : new Tuple<int?, string>(null, "Aun no se puede dar la primera dosis. Seg�n esquema de vacunaci�n es a partir de los 2 meses de vida.");
            ...
            case 2: return (DateTime.Now >= alreadyApplied[1].AppliedDate.AddMonths(8)) ? new Tuple<int?, string>(203, "Refuerzo aplicado") : new Tuple<int?, string>(null, "Aun no se puede dar el refuerzo. Deben pasar 8 meses para su aplicaci�n.");
        }
