...
public class F_Rotavirus : Vaccine
{
    ...
    protected override Tuple<int?, string> internalValidation(Patient patient)
    {
        ...
        return (DateTime.Now >= iDate.AddMonths(2)) ? new Tuple<int?, string>(601, "Primera dosis aplicada") : new Tuple<int?, string>(null, "Aun no se puede dar la primera dosis. Seg�n esquema de vacunaci�n es a partir de los 2 meses de vida.");
    }
}
