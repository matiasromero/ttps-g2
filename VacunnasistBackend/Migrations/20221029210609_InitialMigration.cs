    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Calle Falsa 1234, La Plata", new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), "11111111", "admin@vacunassist.com", "Administrador", "other", false, true, "1000:jT6l1Asi6W4k1q00uWVcl8hMq/S76n0a:exmSn+Y9hzgyKrtSv2ZNBdNWXFavGniQ", false, "Buenos Aires", "administrator", "Admin" },
                    { 2, "Calle Falsa 2345, La Plata", new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), "22345678", "operador1@vacunassist.com", "Luis Gutierrez", "male", false, true, "1000:u5jiWNsd0h0xm5DrIs8+eEkfAI9JwHjb:zoEddnZEYdXG+843oYwXWQDsv56gfvCa", false, "Buenos Aires", "operator", "Operador1" },
                    { 3, "Calle Falsa 9874, Salta", new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), "89785451", "estefania@vacunassist.com", "Estefania Borzi", "female", false, true, "1000:N5vjdHqc2Ry2mqoiGuQFM95wOk/X2zSY:GBmc3PIyuGrhRLmaCu/cPVwzPXkwbxry", false, "Salta", "operator", "Operador2" },
                    { 4, "Calle Falsa 9874, Salta", new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), "89785451", "jr@vacunassist.com", "Jose Luis Rodriguez", "male", false, true, "1000:hMeO6WOO2untQrqblu7KvTdm5ZqIy1/u:XJpp4DefQ2hqtLg69qGU+07pjJLKQR2F", false, "Buenos Aires", "analyst", "Analista1" },
                    { 5, "Calle Falsa 4567, La Plata", new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), "11111111", "vacunador@email.com", "Vacunador", "other", false, true, "1000:epJ6pRgcWCdnmU69Z+uxUZkxu+1syNXm:HfLFXfMeBnbgPci1QC5er6GndiBstm42", false, "Buenos Aires", "vacunator", "Vacunador" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "FLU140012580", null, 3, null, new DateTime(2022, 10, 29, 18, 6, 9, 303, DateTimeKind.Local).AddTicks(2680), 1400, 0 },
                    { 2, "FLU140012581", null, 3, null, new DateTime(2022, 10, 29, 18, 6, 9, 303, DateTimeKind.Local).AddTicks(2681), 1200, 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 5, new DateTime(2022, 10, 29, 18, 6, 9, 303, DateTimeKind.Local).AddTicks(2707), 0, "Buenos Aires", 600, 600 });

            migrationBuilder.InsertData(
                table: "AppliedVaccines",
                columns: new[] { "Id", "AppliedDate", "AppliedDose", "LocalBatchVaccineId", "PatientId", "UserId" },
                values: new object[] { 1, new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), 0, 1, 1, 5 });

            migrationBuilder.InsertData(
                table: "AppliedVaccines",
                columns: new[] { "Id", "AppliedDate", "AppliedDose", "LocalBatchVaccineId", "PatientId", "UserId" },
                values: new object[] { 2, new DateTime(2022, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), 0, 1, 2, 5 });
